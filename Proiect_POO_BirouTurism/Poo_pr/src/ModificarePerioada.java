...
public class ModificarePerioada extends JFrame{
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ModificarePerioada window = new ModificarePerioada();
     ...
     */
    public ModificarePerioada() {
        initSejururi();
        initialize();
    }
    public ModificarePerioada(Sejururi sj) {
        this.sj = sj;
        initialize();
        
    }
    public ModificarePerioada(Sejururi sj,JFrame jf) {
        this.jf = jf;
        this.sj = sj;
        initialize();
